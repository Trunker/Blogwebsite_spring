...
<body>
	<div class="jumbotron" style="background-color: #FFFFFF">
		...
		<div class="alert alert-primary" role="alert">Nice to meet you</div>

	
	
		<%-- <sf:form method="POST" action="register"  modelAttribute="user">
			<div class="form-group">
				<sf:label path="userName" for="inputUserName">User Name</sf:label> 
			...
			<div class="form-group">
				<sf:label path="password" for="inputPassword">Password</sf:label> 
